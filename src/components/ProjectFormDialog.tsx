...
export const ProjectFormDialog: React.FC<ProjectFormDialogProps> = ({
  ...
  const [verificationItems, setVerificationItems] = useState<
    AttachmentVerificationItem[]
  >([]);
  const [verificationRunning, setVerificationRunning] = useState(false);
  console.log("verificationItems", verificationItems);
  useEffect(() => {
    if (open) {
      if (project) {
  ...
  const handleConfirmVerification = () => {
    ...
    const accepted = verificationItems
              ...
              <section className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      value={form.P_Name || ""}
                      onChange={(e) =>
                        !isView && update("P_Name", e.target.value)
                      }
                      required={!isView}
                      disabled={isView}
                      className="h-10"
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      value={form.P_Type || ""}
                      onChange={(e) =>
                        !isView && update("P_Type", e.target.value)
                      }
                      disabled={isView}
                      className="h-10"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative flex items-stretch">
                      <Input
                        ...
                        onChange={(e) =>
                          !isView &&
                          handleDateChange("P_BidStartDate", e.target.value)
                        }
                        disabled={isView}
                        className="h-10 pr-0 text-sm rounded-r-none"
                      />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative flex items-stretch">
                      <Input
                        ...
                        onChange={(e) =>
                          !isView &&
                          handleDateChange("P_BidEndDate", e.target.value)
                        }
                        disabled={isView}
                        className="h-10 pr-0 text-sm rounded-r-none"
                      />
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      !isView && update("P_Description", e.target.value)
                    }
                    disabled={isView}
                    rows={3}
                  ...
                  {project && (
                    <>
                      {loadingAttachments ? (
                          ...
                          {!isView && attachmentIdsToDelete.length > 0 && (
                            <div className="space-y-1">
                              ...
                              <ul className="space-y-1">
                                {existingAttachments
                                  .filter((a) =>
                                    attachmentIdsToDelete.includes(a.id),
                                  )
                                  .map((a) => (
                                    <li
                                      key={a.id}
                        ...
                        project ? null : existingAttachments.length === 0 &&
                        project ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Our AI is reviewing your files and describing their relevance
                  to this project.
                </p>
              </div>
            </div>
