...
const GridIcon = ({ active }: { active?: boolean }) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={active ? styles.iconActive : ''}>
        <path d="M3 4a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4zm0 9a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-3zm9-9a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-3a1 1 0 0 1-1-1V4zm0 9a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-3a1 1 0 0 1-1-1v-3z" fill="currentColor" />
    </svg>
);
...
const IdentityIcon = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M10 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM4 12a4 4 0 0 0-4 4v1a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1v-1a4 4 0 0 0-4-4H4z" fill="currentColor" />
    </svg>
);

const ShieldCheckIcon = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M10 2l6 2.5v5.5a5.5 5.5 0 0 1-3.5 5.1L10 17l-2.5-1.9A5.5 5.5 0 0 1 4 10V4.5L10 2zm0 2.2L6 5.3v4.7a3.5 3.5 0 0 0 2.2 3.2L10 14.5l1.8-1.4A3.5 3.5 0 0 0 14 10V5.3L10 4.2zm1.35 4.65L9.5 12.5 8.15 11.15 9 10.3l.5.5 1.85-1.85 1.35 1.35z" fill="currentColor" />
    </svg>
);
