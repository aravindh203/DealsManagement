...
const FolderIcon = ({ className }: { className?: string }) => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M2 5a2 2 0 0 1 2-2h4.586a1 1 0 0 1 .707.293L10 5.414 8.293 3.707A1 1 0 0 0 7.586 3H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-5.586a1 1 0 0 1-.707-.293L9.586 3.293A1 1 0 0 0 8.586 3H4z" fill="currentColor" />
    </svg>
);

const DocIcon = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5 2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7.414a2 2 0 0 0-.586-1.414L11.586 2.586A2 2 0 0 0 10.414 2H5zm0 2h4.586L15 8.414V16H5V4z" fill="#60a5fa" />
    </svg>
);

const XlsxIcon = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5 2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7.414a2 2 0 0 0-.586-1.414L11.586 2.586A2 2 0 0 0 10.414 2H5zm0 2h4.586L15 8.414V16H5V4z" fill="#22c55e" />
    </svg>
);

const PdfIcon = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5 2a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7.414a2 2 0 0 0-.586-1.414L11.586 2.586A2 2 0 0 0 10.414 2H5zm0 2h4.586L15 8.414V16H5V4z" fill="#ef4444" />
    </svg>
);
...
const DownloadIcon = () => (
    <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M10 3v10m0 0l-4-4m4 4l4-4M3 15h14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

const RefreshIcon = () => (
    <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M16 10a6 6 0 1 1-12 0 6 6 0 0 1 12 0zM14 10l-2 2-2-2" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
const ClockIcon = () => (
    <svg width="14" height="14" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M10 18a8 8 0 1 0 0-16 8 8 0 0 0 0 16z" stroke="currentColor" strokeWidth="2" />
    </svg>
);
...
const assets: Asset[] = [
    { id: '1', name: 'Legal Contracts', type: 'folder', sizeInfo: '-- FOLDER', modification: 'Oct 24, 2023', ownership: 'INTERNAL ENTITY' },
    { id: '2', name: 'Acme Project Alpha Proposal.docx', type: 'docx', sizeInfo: '2.4 MB • DOCX', modification: 'Just now', ownership: 'ACME CORP', ownershipExternal: true },
    { id: '3', name: 'Global Tech Q3 Financial Review.xlsx', type: 'xlsx', sizeInfo: '1.1 MB • XLSX', modification: '2 hrs ago', ownership: 'GLOBAL TECH', ownershipExternal: true },
    { id: '4', name: 'Stark Compliance_v2.pdf', type: 'pdf', sizeInfo: '4.8 MB • PDF', modification: 'Yesterday', ownership: 'STARK INDUSTRIES', ownershipExternal: true },
    { id: '5', name: 'Shared Handbook.pdf', type: 'pdf', sizeInfo: '3.2 MB • PDF', modification: 'Oct 20, 2023', ownership: 'INTERNAL ENTITY' },
    { id: '6', name: 'Acme Assets.zip', type: 'zip', sizeInfo: '15 MB • ZIP', modification: 'Oct 20, 2023', ownership: 'ACME CORP', ownershipExternal: true },
];
                    ...
                    <div className={styles.twoCol}>
                                ...
                                <table className={styles.assetTable}>
                                    ...
                                    <tbody>
                                        {assets.map((a) => (
                                            <tr
                                                key={a.id}
                                                className={selectedId === a.id ? styles.rowSelected : ''}
                                                onClick={() => setSelectedId(a.id)}
                                            >
                                                <td>
                                                    <div className={styles.resourceCell}>
                                                        <span className={a.type === 'folder' ? styles.iconFolder : styles.iconFile}>
                                                            {getAssetIcon(a.type)}
                                                        </span>
                                                        <div>
                                                            <span className={styles.assetName}>{a.name}</span>
                                                            <span className={styles.assetMeta}>{a.sizeInfo}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className={styles.modCell}>{a.modification}</td>
                                                <td>
                                                    <span className={a.ownershipExternal ? styles.ownerExternal : styles.ownerInternal}>
                                                        {a.ownershipExternal && <span className={styles.ownerDot} />}
                                                        {a.ownership}
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className={styles.verificationBadge}>
                                                        <span className={styles.verificationCheck}>✓</span> AES-256
                                                    </span>
                                                </td>
                                            </tr>
                                        ))}
                        ...
                        <div className={styles.detailPanel}>
                            ...
                            <dl className={styles.detailProps}>
                                <dt>RESOURCE TYPE</dt>
                                <dd>{selected.type === 'folder' ? 'FOLDER' : selected.type.toUpperCase()}</dd>
                                <dt>ALLOCATION SIZE</dt>
                                <dd>{selected.type === 'folder' ? '—' : selected.sizeInfo.split(' • ')[0]}</dd>
